...
void main() {
    ...
    int off_x1 = int(0.5*buffer_width  * cos(elapsedTime*0.10309));
    int off_y1 = int(0.5*buffer_height * sin(elapsedTime*0.08130));
    int off_x2 = int(0.5*buffer_width  * sin(elapsedTime*0.07299));
